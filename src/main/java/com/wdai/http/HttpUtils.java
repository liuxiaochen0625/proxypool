...
/**
 * @author reus
 * @version $Id: HttpUtils.java, v 0.1 2017-07-20 reus Exp $
 */
public class HttpUtils {
    public static String getHtml(String url, String ip, String port) {
        ...
        httpGet.setHeader(
            "Cookie",
            "_free_proxy_session=BAh7B0kiD3Nlc3Npb25faWQGOgZFVEkiJTRkYjMyM"
    ...
    public static String getHtml(String url) throws ClassNotFoundException, IOException {
        String entity = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
